...
fs_axes   = 14;   % tick labels
fs_label  = 16;   % x/y labels
fs_title  = 16;   % titles
...
% Load Longitudinal matrices for this CG / V (not actually used directly here)
...
function [t, X, U] = eulerImpulseSim(A, B, chan, mag_deg, pulse_s, T_end, dt)
    ...
    % Build control pulse on the selected channel (deflection in deg → rad)
