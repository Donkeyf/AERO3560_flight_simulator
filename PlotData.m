% Extracts the relevant data from the aircraft state array and control
% array generated by the simulation and plots variables to be aalaysed in
% the main report.
%
% Inputs
% t - Time series vector.
% x - Complete aircraft state array throughout the simulation.
% u - Complete aircraft control array used to complete
% simulation/manoeuvre.
%
% Outputs
% None (displays plots)
